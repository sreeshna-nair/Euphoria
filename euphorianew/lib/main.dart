...
import 'package:euphoria/firebase_functions/setup.dart';
import 'package:euphoria/hivemodel/journaldatamodel.dart';
import 'package:euphoria/splash_screen.dart';
...
Future<void> main() async {
  ...
  await Hive.openBox<AddShopData>('shopData');
  runApp(const MyApp());
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => GetjournaldataBloc(),
      child: MaterialApp(
          title: 'Flutter Demo',
          theme: ThemeData(
